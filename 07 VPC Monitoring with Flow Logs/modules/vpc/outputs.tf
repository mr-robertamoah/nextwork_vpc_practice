...
# Flow Logs Outputs
output "public_subnet_flow_log_id" {
  description = "ID of the public subnet flow log"
  value       = var.enable_flow_logs ? aws_flow_log.public_subnet_flow_log[0].id : null
}
